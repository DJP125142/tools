...
class SendMsg
{
     ...
     * @param array array('code'=>'',....) 短信模板中字段的值
     * @return stdClass
     */
    public static function sendSms($phoneNumber, $options, $signName, $templateCode) {
        ...
        $request->setTemplateParam(json_encode($options, JSON_UNESCAPED_UNICODE));//$options短信模板中字段的值
...
//
//$response = SendMsg::sendSms();
//echo "发送短信(sendSms)接口返回的结果:\n";
//print_r($response);

//sleep(2);

//$response = SendMsg::sendBatchSms();
//echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
//print_r($response);
//
//sleep(2);
//
//$response = SendMsg::querySendDetails();
